...
const Learn = () => {
  ...
  return (
    <div
      className={`h-[100%] w-[100%] xl:pb-[0%] lg:pb-[0%] md:pb-[0%] pb-[23%] ${
        mode === "light" ? "bg-slate-200" : "bg-[#050e13]"
      }`}
    >
      {/* Bar */}
      <div
        className={`top-[60px] left-0 shadow-2xl w-full sticky ${
          mode === "light"
            ? "bg-blue-200 text-blue-900 font-semibold"
            : "bg-[#062436] text-white"
        }  h-10 z-[50] flex flex-row items-center`}
      >
        <div
          onClick={() => setOpen(!open)}
          className={`text-3xl w-[45px] ${
            mode === "light"
              ? "bg-blue-200 text-blue-900 "
              : "bg-[#062436] text-white"
          }  pl-2  mt-1 hover:text-blue-100 transition-all md:hidden
             duration-150 ease-in-out hover:scale-[1.04] cursor-pointer`}
        >
          <div onClick={() => setOpen(!open)}>
            {open ? <IoClose /> : <IoListOutline />}
          </div>
        </div>
      ...
      <div
        className={`flex h-[100%] ${
          mode === "light"
            ? "bg-slate-200 text-blue-900 font-semibold "
            : "bg-[#062436] text-white"
        }`}
      >
        {/* SIDEBAR */}
        <div
          className={`xl:h-relative lg:h-relative md:h-relative 
          xl:h-[1700px] lg:h-[1720px] md:h-[1890px] sm:h-[2000px] h-[2370px]
        md:w-[250px] w-[200px] 
        left-0 
        top-25 
        ...
        >
          <ul className="mt-16 px-6 sticky left-4 top-32">
            ...
            <div className="flex mt-12">
              ...
              <span className="  text-xl font-bold mb-2 ml-1">Guides</span>
            </div>
        ...
        <div className=" bg-[red] flex flex-col w-full h-[100%]">
          <div
            className={`w-full h-[500px] ${
              mode === "light"
                ? "learn-banner-light text-[#1b4169] text-glow-light"
                : "learn-banner"
          ...
          >
            <div className="flex flex-col w-[50%]">
              <h1 className="text-6xl font-bold  mb-2">LEARN CRYPTO.</h1>
              <p className="text-md ">
              ...
              <button
                className={`${
                  mode === "light"
                    ? "newscard-filter-light text-slate-800 hover:text-slate-200 hover:scale-[1.05]"
                    : "bg-blue-500 hover:bg-blue-200 hover:text-blue-800"
                }  mt-4 py-1 w-32 font-bold rounded-lg text-sm
          ...
          <div
            className={`${
              mode === "light" ? "bg-slate-200 text-slate-900" : "bg-[#061016]"
            }  h-[100%] w-[100%] xl:px-[16%] lg:px-[12%] md:px-[10%] px-[10%]`}
          >
            <div
              className=" 
          w-[100%]
          ...
          md:my-0 my-6 flex items-center justify-center
           hover:scale-[1.01]  ${
             mode === "light"
               ? "learn-card-banner-light hover:shadow-blue-100/90 shadow-blue-500/90"
               : "learn-card-banner hover:shadow-yellow-100/50 shadow-yellow-400/50"
           }
           shadow-xl transition-all ease-in-out`}
            ...
            hover:rotate-[360deg]  ${
              mode === "light"
                ? "text-blue-200 border-blue-300 hover:border-blue-100 hover:text-blue-100"
                : "text-yellow-200 border-yellow-300 hover:border-yellow-100 hover:text-yellow-100"
            }`}
                >
                  <IoLogoBitcoin />
                </div>
