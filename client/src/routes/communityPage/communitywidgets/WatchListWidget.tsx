...
import { IoChevronForwardOutline, IoEyeOutline, IoStar, IoStarOutline } from "react-icons/io5";
...
interface WatchListWidgetType {
  ...
  addToWatchList: (coin: object) => void;
  removetoWatchList: (coin: object) => void;
}
