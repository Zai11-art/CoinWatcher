...
const CoinNews = () => {
  ...
  return (
    <div className="xl:mt-[70px] lg:mt-[10px] md:mt-[1700px] sm:mt-[1100px] mt-[1200px]
      ...
      <div className={`mt-[2400px] md:mt-[1800px] lg:mt-[250px] xl:mt-[200px]
            ${mode === "light" ? "bg-slate-200 text-blue-900 shadow-xl"
            : "chart text-white"} flex items-center justify-around
        ...
        <Carousel slide={true} className="px-16 pb-12">
          ...
          <div className="flex flex-col items-center justify-around md:flex-col lg:flex-row xl:flex-row">
            {news.slice(data.first, data.second).map((data, index) => (
              <div className={`${mode === "light" ? "" : "shadow-blue-500/50"}
                ...
                <div
                  ...
                  ${mode === "light" ? "bg-slate-300/30 font-semibold text-slate-900 shadow-xl"
                  : "bg-[#161c26] text-white"} p-3`}>
                  ...
                  <a className={`mb-2 mt-6 flex cursor-pointer justify-center rounded-lg p-1 
                    ${mode === "light" ? "newscard-filter-light text-glow font-bold text-blue-900 hover:bg-blue-100 hover:text-blue-500"
